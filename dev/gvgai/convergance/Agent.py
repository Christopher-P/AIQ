...
import random
from utils.AbstractPlayer import AbstractPlayer
...
class Agent(AbstractPlayer):
    ...
    def __init__(self):
        ...
        self.epsilon_decay = 1500  # Epsilon decay rate in terms of steps for epsilon-greedy policy
    ...
    def init(self, sso, elapsed_timer, train_eps=3):
        """
        ...
        :return:
        """
        self.epsilon_decay = 1500 * train_eps
        ...
        if self.running_mode == 0:
            ...
            dimensions = [0.0, 0.0] # [self.worldDimension[0]/self.blockSize, self.worldDimension[1]/self.blockSize]
    ...
    def act(self, sso, elapsed_timer):
        ...
        # return sso.availableActions[self.previous_action].index()
